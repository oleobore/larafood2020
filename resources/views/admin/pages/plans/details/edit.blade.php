...
@section('content_header')
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active"><a href="{{ route('details.plan.edit', [$plan->slug, $detail->id]) }}" class="active">Editar</a></li>
    </ol>
...
@section('content')
    <div class="card">
      <div class="card-body">
       <form action="{{ route('details.plan.update', [$plan->slug, $detail->id]) }}" method="post">
        @method('PUT')
